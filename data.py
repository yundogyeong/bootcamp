...
with open('/content/data/cifar-10-batches-py/batches.meta', 'rb') as infile:
    data = pickle.load(infile, encoding='latin1')
    classes = data['label_names']

# 클래스 별 폴더 생성
os.mkdir('/content/data/cifar-10-batches-py/train')
os.mkdir('/content/data/cifar-10-batches-py/test')
for name in classes:
    os.mkdir('/content/data/cifar-10-batches-py/train/{}'.format(name))
    os.mkdir('/content/data/cifar-10-batches-py/test/{}'.format(name))
    
# Trainset Unpacking
# data_batch 파일들 순서대로 unpacking
for i in range(1, 6):
    print('Unpacking Train File {}/{}'.format(i, 5))
    train_file = unpickle('/content/data/cifar-10-batches-py/data_batch_{}'.format(i))
    ...
    for idx in range(10000):
        ...
        # 클래스 별 폴더에 파일 저장
        train_image.save('/content/data/cifar-10-batches-py/train/{}/{}'.format(classes[train_label], train_filename[idx].decode('utf8')))
        
# -----------------------------------------------------------------------------------------

# Testset Unpacking
print('Unpacking Test File')
test_file = unpickle('/content/data/cifar-10-batches-py/test_batch')
...
for idx in range(10000):
    ...
    # 클래스 별 폴더에 파일 저장
    test_image.save('/content/data/cifar-10-batches-py/test/{}/{}'.format(classes[test_label], test_filename[idx].decode('utf8')))
