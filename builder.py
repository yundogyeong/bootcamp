...
class EngineCalibrator(trt.IInt8EntropyCalibrator2):
    ...
    trt.IInt8EntropyCalibrator2 <<< usually use it to CNN model
...
class EngineBuilder:
    ...
    def create_engine(self, engine_path, precision, calib_input=None, calib_cache=None, calib_num_images=5000,
        ...
        :param precision: The datatype to use for the engine, either 'int8', 'fp16' or 'mix'.
...
if __name__ == "__main__":
    ...
    parser.add_argument("-p", "--precision", default="int8", choices=["int8", "fp16", "mix"],
                        help="The precision mode to build in, either 'int8', 'fp16' or 'mix', default: 'int8'")
    ...
    if not all([args.onnx, args.engine]):
        ...
        sys.exit(1)
    if args.precision == ("int8" or "mix") and not (args.calib_input or os.path.exists(args.calib_cache)):
        parser.print_help()
